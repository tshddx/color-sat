...
const base = [
  ...
  // Border
  "border border-gray-950/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-gray-950/30 group-data-checked:bg-(--radio-checked-border)",
  ...
  "[--radio-indicator:transparent] group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] group-data-hover:[--radio-indicator:var(--color-gray-900)]/10",
  // Indicator color (dark mode)
  "dark:group-data-hover:group-data-checked:[--radio-indicator:var(--radio-checked-indicator)] dark:group-data-hover:[--radio-indicator:var(--color-gray-700)]",
  // Focus ring
  "group-data-focus:outline group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-blue-500",
  // Disabled state
  "group-data-disabled:opacity-50",
  "group-data-disabled:border-gray-950/25 group-data-disabled:bg-gray-950/5 group-data-disabled:[--radio-checked-indicator:var(--color-gray-950)]/50 group-data-disabled:before:bg-transparent",
...
const colors = {
  "dark/gray": [
    "[--radio-checked-bg:var(--color-gray-900)] [--radio-checked-border:var(--color-gray-950)]/90 [--radio-checked-indicator:var(--color-white)]",
    "dark:[--radio-checked-bg:var(--color-gray-600)]",
  ],
  "dark/white": [
    "[--radio-checked-bg:var(--color-gray-900)] [--radio-checked-border:var(--color-gray-950)]/90 [--radio-checked-indicator:var(--color-white)]",
    "dark:[--radio-checked-bg:var(--color-white)] dark:[--radio-checked-border:var(--color-gray-950)]/15 dark:[--radio-checked-indicator:var(--color-gray-900)]",
  ],
  white:
    "[--radio-checked-bg:var(--color-white)] [--radio-checked-border:var(--color-gray-950)]/15 [--radio-checked-indicator:var(--color-gray-900)]",
  dark: "[--radio-checked-bg:var(--color-gray-900)] [--radio-checked-border:var(--color-gray-950)]/90 [--radio-checked-indicator:var(--color-white)]",
  gray: "[--radio-checked-indicator:var(--color-white)] [--radio-checked-bg:var(--color-gray-600)] [--radio-checked-border:var(--color-gray-700)]/90",
