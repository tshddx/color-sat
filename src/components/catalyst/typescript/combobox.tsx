      ...
      >
        <Headless.ComboboxInput
          ...
          className={clsx([
            ...
            // Disabled state
            "data-disabled:border-gray-950/20 dark:data-disabled:border-white/15 dark:data-disabled:bg-white/2.5 dark:data-hover:data-disabled:border-white/15",
            // System icons
            "dark:scheme-dark",
          ])}
        />
        <Headless.ComboboxButton className="group absolute inset-y-0 right-0 flex items-center px-2">
          <svg
            className="size-5 stroke-gray-500 group-data-disabled:stroke-gray-600 group-data-hover:stroke-gray-700 sm:size-4 dark:stroke-gray-400 dark:group-data-hover:stroke-gray-300 forced-colors:stroke-[CanvasText]"
            viewBox="0 0 16 16"
            aria-hidden="true"
            fill="none"
          >
