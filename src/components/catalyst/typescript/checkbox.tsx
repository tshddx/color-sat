...
const base = [
  ...
  // Border
  "border border-gray-950/15 group-data-checked:border-transparent group-data-hover:group-data-checked:border-transparent group-data-hover:border-gray-950/30 group-data-checked:bg-(--checkbox-checked-border)",
  ...
  "group-data-disabled:border-gray-950/25 group-data-disabled:bg-gray-950/5 group-data-disabled:[--checkbox-check:var(--color-gray-950)]/50 group-data-disabled:before:bg-transparent",
...
const colors = {
  "dark/gray": [
    "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-gray-900)] [--checkbox-checked-border:var(--color-gray-950)]/90",
    "dark:[--checkbox-checked-bg:var(--color-gray-600)]",
  ],
  "dark/white": [
    "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-gray-900)] [--checkbox-checked-border:var(--color-gray-950)]/90",
    "dark:[--checkbox-check:var(--color-gray-900)] dark:[--checkbox-checked-bg:var(--color-white)] dark:[--checkbox-checked-border:var(--color-gray-950)]/15",
  ],
  white:
    "[--checkbox-check:var(--color-gray-900)] [--checkbox-checked-bg:var(--color-white)] [--checkbox-checked-border:var(--color-gray-950)]/15",
  dark: "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-gray-900)] [--checkbox-checked-border:var(--color-gray-950)]/90",
  gray: "[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-gray-600)] [--checkbox-checked-border:var(--color-gray-700)]/90",
