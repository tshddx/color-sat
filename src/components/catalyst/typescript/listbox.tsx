    ...
    <Headless.Listbox {...props} multiple={false}>
      <Headless.ListboxButton
        ...
        className={clsx([
          ...
          // Disabled state
          "data-disabled:opacity-50 data-disabled:before:bg-gray-950/5 data-disabled:before:shadow-none",
        ])}
      >
        <Headless.ListboxSelectedOption
          ...
          options={options}
          placeholder={
            placeholder && <span className="block truncate text-gray-500">{placeholder}</span>
          }
          className={clsx([
            // Basic layout
            ...
            // Disabled state
            "group-data-disabled:border-gray-950/20 group-data-disabled:opacity-100 dark:group-data-disabled:border-white/15 dark:group-data-disabled:bg-white/2.5 dark:group-data-disabled:data-hover:border-white/15",
          ])}
        />
