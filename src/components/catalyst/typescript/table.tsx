  ...
  return (
    ...
    >
      <div className="flow-root">
        <div
          {...props}
          className={clsx("-mx-(--gutter) overflow-x-auto whitespace-nowrap", className)}
        >
          <div
...
export function TableHead({ className, ...props }: React.ComponentPropsWithoutRef<"thead">) {
  return <thead {...props} className={clsx("text-gray-500 dark:text-gray-400", className)} />;
}
...
export function TableHeader({ className, ...props }: React.ComponentPropsWithoutRef<"th">) {
  ...
  return (
    <th
      {...props}
      className={clsx(
        "border-b border-b-gray-950/10 px-4 py-2 font-medium first:pl-(--gutter,--spacing(2)) last:pr-(--gutter,--spacing(2)) dark:border-b-white/10",
